...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 12 mars 2026 à 11:37
...
ALTER TABLE `locations`
  ...
  ADD KEY `fk_loc_dept` (`DEP_ID_LOC`);
...
--
ALTER TABLE `employees`
  ADD CONSTRAINT `fk_emp_dept` FOREIGN KEY (`DEP_ID`) REFERENCES `departments` (`DEPT_ID_DEP`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_emp_job` FOREIGN KEY (`JOB_ID`) REFERENCES `jobs` (`JOB_IDENT`);

--
-- Contraintes pour la table `job_history`
--
ALTER TABLE `job_history`
  ADD CONSTRAINT `fk_hist_emp` FOREIGN KEY (`EMPL_ID`) REFERENCES `employees` (`EMP_ID`),
  ADD CONSTRAINT `fk_hist_job` FOREIGN KEY (`JOBS_ID`) REFERENCES `jobs` (`JOB_IDENT`);

--
-- Contraintes pour la table `locations`
--
ALTER TABLE `locations`
  ADD CONSTRAINT `fk_loc_dept` FOREIGN KEY (`DEP_ID_LOC`) REFERENCES `departments` (`DEPT_ID_DEP`);
COMMIT;
